const locale = {
  ...
  TABS: {
    ...
    INSTALLMENT_CONTENT: `
      يتم توزيع المبلغ الممول على 12 قسطًا شهريًا متساويًا،
      حيث يبلغ متوسط كل قسط 1,800 درهم إماراتي. يشمل القسط
      كلاً من المبلغ الأساسي ورسوم ربح/هامش صغيرة تقل تدريجياً
      مع مرور فترة السداد.

      القسط الأول مستحق في 1 أكتوبر 2025 بمبلغ 1,866.67 درهم،
      وبعدها ينخفض الرصيد إلى 18,333.33 درهم.

      في كل شهر لاحق، ينخفض القسط قليلاً مع انخفاض جزء الربح.

      بحلول القسط الأخير في سبتمبر 2026، يدفع الوالد 1,666.67 درهم
      لتسوية الرصيد بالكامل.

      إجمالاً، يدفع الوالد 25,070 درهم على مدار 12 شهرًا، وهو ما
      يغطي الرسوم الدراسية الممولة بالإضافة إلى هامش ربح إجمالي
      قدره 1,070 درهم.

      تضمن هذه الخطة للوالدين إمكانية إدارة نفقات المدرسة بشكل أكثر
      مرونة دون التأثير على تعليم أطفالهم.
    `,
    TERMS_CONTENT: `
